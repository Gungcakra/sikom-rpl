<div class="d-flex flex-column flex-column-fluid">
    <x-slot:title>Manajemen Organisasi</x-slot:title>
    <!--begin::Toolbar-->
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Manajemen Organisasi</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex items-center">
                {{-- <input type="text" class="form-control form-control-solid" placeholder="Cari Organisasi Name" id="search" autocomplete="off" wire:model.live.debounce.100ms="search" /> --}}
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <button class="btn btn-sm fw-bold btn-primary" wire:click="create()">Tambah Organisasi</button>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card p-5">
                ...
                <div class="table-responsive">
                    <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5">
                        ...
                        <tbody>
                            ...
                            @else
                            @foreach ($data as $index => $organisasi)
                            <tr wire:key="Organisasi-{{ $organisasi->id_organisasi }}">
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a wire:click="edit({{ $organisasi->id_organisasi }})" class="menu-link px-3 w-100">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                ...
                                <td>{{ Str::limit($organisasi->deskripsi, 50) }}</td>
               ...
               @include('livewire.pages.admin.masterdata.organisasi.modal')
            </div>
...
<script>
    $(function() {
        ...
        var modalEl = document.getElementById('organisasiModal');
